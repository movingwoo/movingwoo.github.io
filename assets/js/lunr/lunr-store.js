var store = [{
        ...
        "title": "3655번 먼저 가세요",
        "excerpt":"문제 3655번 먼저 가세요 - 백준 설계 쉬워보였는데 생각할게 좀 많다. 양보를 하게되면 그룹의 첫 사람과 마지막 사람의 순서차이 * 5초만큼 이득이다. 공식 잘 만들면 되려나 싶어서 계산해봤는데 너무 복잡하다. 고려할게 너무 많다. 그렇다면 그리디는 어떨까? 큐를 만들어서 넣고 만지작거리는데 너무 오래걸릴 것 같은 예감 그리디도 결국 시뮬레이션인데 넣다 뺐다...","categories": ["random-solve/Python/"],
